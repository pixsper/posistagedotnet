...
public sealed class PsnDataPacketChunk : PsnPacketChunk
{
	...
	public PsnDataPacketChunk(IEnumerable<PsnDataPacketSubChunk> subChunks)
	...
	private PsnDataPacketChunk(IEnumerable<PsnChunk> subChunks) : base(subChunks) { }
...
public abstract class PsnDataPacketSubChunk : PsnChunk
{
	...
	protected PsnDataPacketSubChunk(IEnumerable<PsnChunk>? subChunks) : base(subChunks) { }
