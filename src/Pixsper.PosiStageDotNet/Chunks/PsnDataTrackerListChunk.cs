...
public sealed class PsnDataTrackerListChunk : PsnDataPacketSubChunk
{
	...
	public PsnDataTrackerListChunk(IEnumerable<PsnDataTrackerChunk> subChunks)
	...
	private PsnDataTrackerListChunk(IEnumerable<PsnChunk> subChunks) : base(subChunks) { }
...
public sealed class PsnDataTrackerChunk : PsnChunk, IEquatable<PsnDataTrackerChunk>
{
	...
	/// <param name="subChunks">Typed sub-chunks of this chunk</param>
	public PsnDataTrackerChunk(int trackerId, IEnumerable<PsnDataTrackerSubChunk> subChunks)
	...
	private PsnDataTrackerChunk(int trackerId, IEnumerable<PsnChunk> subChunks)
		: base(subChunks)
	{
...
public abstract class PsnDataTrackerSubChunk : PsnChunk
{
	...
	/// </summary>
	/// <param name="subChunks">Typed sub-chunks of this chunk</param>
	protected PsnDataTrackerSubChunk(IEnumerable<PsnChunk>? subChunks) : base(subChunks) { }
