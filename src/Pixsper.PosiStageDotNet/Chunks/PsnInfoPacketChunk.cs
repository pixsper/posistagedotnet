...
public sealed class PsnInfoPacketChunk : PsnPacketChunk
{
	...
	public PsnInfoPacketChunk(IEnumerable<PsnInfoPacketSubChunk> subChunks)
	...
	private PsnInfoPacketChunk(IEnumerable<PsnChunk> subChunks) : base(subChunks) { }
...
public abstract class PsnInfoPacketSubChunk : PsnChunk
{
	...
	protected PsnInfoPacketSubChunk(IEnumerable<PsnChunk>? subChunks) : base(subChunks) { }
